...
function LiveClassPanel({ k, user, usingApi, onExit }) {
  ...
  return (
    <div style={{ marginTop: 6, fontSize: 13 }}>
      ...
      {/* একবার হাজিরা পাকাপাকি নিশ্চিত হয়ে গেলে (done) "জয়েনের অপেক্ষায়…"
          আর দেখানোর মানে হয় না — অপেক্ষাটা তো শেষ, দুজনে মিলিত হয়েছেন বলেই
          তো হাজিরা বসেছে, আর সেটা কখনো ফিরিয়ে নেওয়া হয় না। রিজয়েনের পর
          এই শর্ত না থাকায় সবুজ লেখাটার বদলে আবার অপেক্ষার লেখা ফিরে আসত। */}
      {!bothIn && !done ? (
