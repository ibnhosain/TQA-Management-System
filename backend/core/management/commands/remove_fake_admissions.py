"""
ভর্তি আবেদনের তালিকায় দুটো স্পষ্ট ফেক/টেস্ট এন্ট্রি ধরা পড়েছিল:
...
পরিচালক এই দুটো এন্ট্রি স্পষ্টভাবে শনাক্ত করে মুছে দিতে বলেছেন। id দিয়ে নয়,
name+contact মিলিয়ে নির্দিষ্ট করা হয়েছে যাতে অন্য কোনো ভবিষ্যতের বৈধ আবেদনে
ভুলবশত হাত না পড়ে।
...
class Command(BaseCommand):
    help = "স্পষ্টভাবে শনাক্ত করা ২টা ফেক/টেস্ট Admission এন্ট্রি মুছে ফেলে"
